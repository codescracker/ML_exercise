...
from llama2.components import Transformer
...
class Llama2:
    ...
    def build(checkpoint_dir: str, load_model: bool, 
        ...
        model = Transformer(vocab_size=vocab_size, d_model=d_model, n_layers=num_layers, 
                        n_heads=num_heads,kv_n_heads=kv_num_heads, 
                        ffn_dim_multiplier=ffn_dim_multiplier, max_batch_size=max_batch_size, max_seq_len=max_seq_len).to(device)
        ...
        return Llama2(model, tokenizer, config)
